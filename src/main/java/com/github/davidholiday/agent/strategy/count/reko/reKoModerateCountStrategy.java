...
public class reKoModerateCountStrategy extends reKoCountStrategy {

    private static final Logger LOG = LoggerFactory.getLogger(reKoModerateCountStrategy.class);

    public static final String NAME = "RE_KO_MODERATE_COUNT_STRATEGY";

    public reKoModerateCountStrategy(RuleSet ruleSet, double baseWager) {
