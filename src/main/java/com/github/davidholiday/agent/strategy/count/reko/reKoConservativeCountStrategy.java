...
public class reKoConservativeCountStrategy extends reKoCountStrategy {

    private static final Logger LOG = LoggerFactory.getLogger(reKoConservativeCountStrategy.class);

    public static final String NAME = "RE_KO_CONSERVATIVE_COUNT_STRATEGY";

    public reKoConservativeCountStrategy(RuleSet ruleSet, double baseWager) {
